...
#ifndef SYNTHESIS_SYNTH_H
#define SYNTHESIS_SYNTH_H

#include <oboe/Oboe.h>
#include <array>

#include "utils/Mixer.h"
#include "utils/SynthSound.h"
#include "utils/MonoToStereo.h"
#include "utils/ITappable.h"
#include "utils/TappableAudioSource.h"
#include "utils/IRenderableAudio.h"
...
public:
    static ::std::shared_ptr<Synth> create(
            const int32_t sampleRate,
            const int32_t channelCount,
            const int32_t numSignals
    ) {
